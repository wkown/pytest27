...
class ExamplePanel(wx.Panel):
    def __init__(self,parent):
        ...
        self.logger = wx.TextCtrl(self, pos=(300, 20), size=(200, 300), style=wx.wx.TE_MULTILINE | wx.TE_READONLY)

        self.button = wx.Button(self, label="Save", pos=(200, 300))
        self.Bind(wx.EVT_BUTTON, self.OnClick, self.button)

        self.lblname = wx.StaticText(self, label="Your name :", pos=(20, 60))
        self.editname = wx.TextCtrl(self, value="How did you hear from us ?", pos=(20, 90))
